...
教师编体育笔试"举一反三"讲稿的成体系生成与反例沉淀。基于招教体育讲义库，按 8 节结构 + 引用/口诀/双链硬约束批量产出讲稿；内置 R1-R20 实战反例、六维度横评机制（全库审核打分）、双视角授课提示与 v2 修订说明模板，md→Word 采用通用提示词（v3.8 替代旧合并脚本，v3.9 新增代码思维导图/时间线转图提示词）。
